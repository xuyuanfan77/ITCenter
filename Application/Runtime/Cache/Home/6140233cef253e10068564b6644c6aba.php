		...
		<form id="sForm" method="post">
			<table cellpadding="5">
				<tr>
					...
					<td>办公电话：</td>
					<td>
						<input id="sOfficePhone" data-options="prompt:'可模糊查询...'" class="easyui-textbox" type="text" name="sOfficePhone"></input>
					</td>
					<td>移动电话：</td>
					<td>
						<input id="sMobilePhone" data-options="prompt:'可模糊查询...'" class="easyui-textbox" type="text" name="sMobilePhone"></input>
					</td>
					<td>
						<div>
